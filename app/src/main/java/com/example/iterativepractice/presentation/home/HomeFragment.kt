package com.example.iterativepractice.presentation.home
...
import com.example.iterativepractice.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.buttonToProducts.setOnClickListener {
